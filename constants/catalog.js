const CATALOG = [
    ...
    {
        id: 'el1',
        name: 'Кнопка 9-pin 3PDT True Bypass on/on',
        img: 'img/catalog/button9pin.JPG',
        price: 127.72,
    },
    {
        id: 'el2',
        name: 'Струны для электрогитары ALICE A503-SL (9-42), никель. Комплект струн',
        img: 'img/catalog/strings-light.JPG',
        price: 293,
    },
    {
        id: 'el3',
        name: 'Блок питания 18V/1A (штекер 5,5*2,5 мм)',
        img: 'img/catalog/block18v.JPG',
        price: 656,
    },
    {
        id: 'el3',
        name: 'KOKKO FPH2 Phaser',
        img: 'img/catalog/kokko.jpg',
        price: 4_801,
    },
]